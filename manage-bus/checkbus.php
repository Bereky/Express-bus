        ...
        <div class="landing">
            ...
            <div class="manage">
                <div class="manage-bus">
                    <a href="./manage-bus.php">
                    <div class="assign-bus" id="assign">
                        <h5>Assign Bus</h5>
                    </div>
                    </a>
                    <div class="check-bus active" id="check-bus"">
                        <h5>Check Bus</h5>
                    </div>
                </div>
                <div class="check" id="check-form">
                    <form method="post" action="checkbus.php" class="form">
                        <label class="bus-label" for="bus-number">Bus Number:</label>
                        <input class="input" type="text" name="bus-number" id="passanger" placeholder="Enter Bus Number" required>
                        <button id="check-btn" type="submit" name="check-bus">Check</button>
                    </form>
                    
                </div>
                <?php if (isset($_SESSION["buscheck-success"])):  ?>
                <div class="check-status">
                    <?php
                        unset($_SESSION['buscheck-failed']);
                    ?>

                    <div class="bus-status-s">
                        <p>Bus Number : <?php echo $_SESSION['busn']; ?> is Assigned to:</p>
                        <p>Origin: <?php echo $_SESSION["orgn"]; ?> </p>
                        <p>Destination: <?php echo $_SESSION["destn"]; ?></p>
                    </div>
                <?php endif ?>
            
                </div>
                <?php if (isset($_SESSION["buscheck-failed"])):  ?>
                    <?php
                    ?>
                    <div class="bus-status-f">
                    <p>The bus is not Assigned!</p>
